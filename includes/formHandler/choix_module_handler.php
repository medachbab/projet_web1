...
if(isset($_POST['submit'])){
    if(isset($_SESSION["prof-consulter"])){
    ...
    elseif(isset($_SESSION["prof-noter"]) && $_SESSION["prof-noter"]== "etudiants"){
        $id_module = $_POST["module"];
        $_SESSION["id_module"] = $id_module;
        unset($_SESSION["prof-noter"]);
        header("location: ../../routing/routing.php?controler=note&action=f2");
    }elseif(isset($_SESSION["etudiant-consulter"]) && $_SESSION["etudiant-consulter"]== "annonces"){
        $id_module = $_POST["module"];
        $_SESSION["id_module"] = $id_module;
