    ...
    <div class="Sidebar">
        ...
        <div class="Services">
                    <ul>
                        ...
                        <div class="Comp"><li><div class="icon"><i class="fa-solid fa-envelope"></i></div><a href="../../../routing/routing.php?controler=annonce&action=f13">ajouter une annonce par classse</a></li></div>
                        ...
                        <div class="Comp"><li><div class="icon"><i class="fa-solid fa-lock"></i></div><a href="../../../routing/routing.php?controler=annonce&action=f19">mes annonces suprimées</a></li></div>                       
